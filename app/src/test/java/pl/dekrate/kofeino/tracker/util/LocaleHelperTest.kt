...
/**
 * Unit tests for [LocaleHelper] using Robolectric.
 *
 * Verifies that:
...
class LocaleHelperTest {
    ...
    @Test
    fun `wrapContext with English sets Locale getDefault to English`() {
        LocaleHelper.wrapContext(context, "en")

        assertEquals("en", java.util.Locale.getDefault().language)
    }
