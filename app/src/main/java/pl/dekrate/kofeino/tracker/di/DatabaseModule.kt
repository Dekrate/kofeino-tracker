...
import pl.dekrate.kofeino.tracker.data.encryption.EncryptedPreferencesSerializer
...
object DatabaseModule {
    ...
    fun provideSettingsDataStore(
        ...
        val encryptedSerializer = EncryptedPreferencesSerializer(
            ...
            associatedData = "kofeino_settings".encodeToByteArray()
        )
        return DataStoreFactory.create(
            serializer = encryptedSerializer,
            corruptionHandler = ReplaceFileCorruptionHandler { emptyPreferences() },
            produceFile = { File(context.filesDir, "datastore/kofeino_settings.preferences_pb") }
        )
    }
    ...
    fun provideSyncStateDataStore(
        ...
        val encryptedSerializer = EncryptedPreferencesSerializer(
            aead = encryptionManager.aead,
            associatedData = "sync_state".encodeToByteArray()
        )
        return DataStoreFactory.create(
            serializer = encryptedSerializer,
            corruptionHandler = ReplaceFileCorruptionHandler { emptyPreferences() },
            produceFile = { File(context.filesDir, "datastore/sync_state.preferences_pb") }
        )
    }
